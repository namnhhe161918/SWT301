...
public void updateProfile(int id, String descyourself, String fullname, String image, String displayname, String address, String dob, String academiclevel, String modifydate, int gender) {
    String sql = "UPDATE [dbo].[User_type]\n"
