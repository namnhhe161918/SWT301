...
import test.com.daos.DAOSubject;
...
public class HomeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            test.com.daos.DAOSubject daoSubject = new DAOSubject();
            test.com.daos.DAOCourse daoCourse = new DAOCourse();
            test.com.daos.DAOMentor daoMentor = new DAOMentor();
            test.com.daos.DAOPost daoPost = new DAOPost();
