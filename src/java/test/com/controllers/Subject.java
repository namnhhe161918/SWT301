    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("add")) {
                ...
                test.com.entities.Subject newSubject = new test.com.entities.Subject(name, relativePath);
            ...
            if (service.equals("edit")) {
                ...
                if (submit == null) {
                    ...
                    test.com.entities.Subject sub = new test.com.entities.Subject(subject_id, name, relativePath, title, description, status);
